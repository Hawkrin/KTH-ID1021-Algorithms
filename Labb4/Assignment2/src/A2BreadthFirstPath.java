 ...
 * Date: 2021-10-09
 */
public class A2BreadthFirstPath {
     ...
     */
    public A2BreadthFirstPath(Graph graph, int sourceVertex) {
     ...
     */
    public A2BreadthFirstPath(Graph graph, Iterable<Integer> sourceVertex) {
        marked = new boolean[graph.V()];
        from = new int[graph.V()];
        distTo = new int[graph.V()];
    ...
    //Breadthfirst search from MULTIPLE sources
